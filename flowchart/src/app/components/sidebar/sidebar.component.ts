...
onActionTypeChange(value: string): void {
  this.updateNodeProperty('Action_type', value);
  if (value === 'Log Screen') {
    this.selectedNode.LogScreen = true;
    this.updateNodeProperty('LogScreen', true);
  }
}
...
// /////////Pour Screen Automator/////////////
// selectedCmdType: string = 'global'; // valeur par défaut
// selectedTextType: string = 'text'; // utilisé pour les types de texte

// onCmdTypeChange() {
//   // Tu peux ajouter de la logique si nécessaire
// }
// ///////////fin///////////
